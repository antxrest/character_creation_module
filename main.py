...
def attack(char_name: str, char_class: str) -> str:
    """Функция описывает количество урона, которое нанес герой."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция описывает количество урона, которое заблокировал герой."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция описывает специальное умение героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция отвечает за запуск и окончание тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция отвечет за выбор класса персонажа."""
    approve_choice = None
    char_class = None
